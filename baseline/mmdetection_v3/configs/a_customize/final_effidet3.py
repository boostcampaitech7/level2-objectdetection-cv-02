_base_ = [
    'mmdet::a_customize/customize_datasets.py',
    'mmdet::a_customize/customize_schedule.py',
    'mmdet::a_customize/customize_runtime.py'
]
custom_imports = dict(
...
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=12, save_best='auto'))
custom_hooks = [
    dict(
        type='EMAHook',
