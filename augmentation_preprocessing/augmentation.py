...
def main():
    ...
    image_path1 = os.path.join(dataset_path, file_name1)
    image_path2 = os.path.join(dataset_path, file_name2)
    ...
    if i + 3 < num_images:
        ...
        image_path3 = os.path.join(dataset_path, file_name3)
        image_path4 = os.path.join(dataset_path, file_name4)
        ...
        image_annotations3 = [
            ann for ann in annotations if ann["image_id"] == image_id3
        ]
        image_annotations4 = [
            ann for ann in annotations if ann["image_id"] == image_id4
        ]
